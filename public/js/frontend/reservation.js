...
document.querySelectorAll('.custom-range').forEach(function (item) {
  item.addEventListener('change', function (event) {
    ...
    duration = parseFloat(document.getElementById('duration_output-' + data_name).value);
    select = document.getElementById("timeslot-" + data_name);
