...
var sunday_lunch_notclosed = document.querySelector('[id^="field-lunchbreak-sunday-"][value="0"]'); // openinghours_halfday_closed_general und openinghourslunchbreak_general auslesen
...
var oh_lunchtime_sunday = document.querySelector('[id^="field-lunchbreackstart-sunday-"]').parentElement.parentElement.parentElement.parentElement; // EventListener WeekDays
...
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/booking-system/resources/assets/js/openinghours.js */"./resources/assets/js/openinghours.js");
