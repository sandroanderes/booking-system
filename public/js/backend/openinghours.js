...
var checked_wednesday = document.querySelector('[id^="field-ohday-wednesday-"]');
...
var checked_sunday = document.querySelector('[id^="field-ohday-sunday-"]'); // openinghours_repeat "Ja"- und "Nein"-Knopf

var oh_repeat = document.querySelector('[id^="field-ohrepeat-"][value="1"]');
var oh_repeat_none = document.querySelector('[id^="field-ohrepeat-"][value="0"]'); // Daily Buttons

var general_open_allday = document.querySelector('[id^="field-ohhalfday-closed-general-"][value="0"]');
var general_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-general-"][value="1"]');
var general_lunch_closed = document.querySelector('[id^="field-ohlunch-general-"][value="1"]');
var general_lunch_notclosed = document.querySelector('[id^="field-ohlunch-general-"][value="0"]');
var monday_open_allday = document.querySelector('[id^="field-ohhalfday-closed-monday-"][value="0"]');
var monday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-monday-"][value="1"]');
var monday_lunch_closed = document.querySelector('[id^="field-ohlunch-monday-"][value="1"]');
var monday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-monday-"][value="0"]');
var tuesday_open_allday = document.querySelector('[id^="field-ohhalfday-closed-tuesday-"][value="0"]');
var tuesday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-tuesday-"][value="1"]');
var tuesday_lunch_closed = document.querySelector('[id^="field-ohlunch-tuesday-"][value="1"]');
var tuesday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-tuesday-"][value="0"]');
var wednesday_open_allday = document.querySelector('[id^="field-ohhalfday-closed-wednesday-"][value="0"]');
var wednesday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-wednesday-"][value="1"]');
var wednesday_lunch_closed = document.querySelector('[id^="field-ohlunch-wednesday-"][value="1"]');
var wednesday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-wednesday-"][value="0"]');
var thursday_open_allday = document.querySelector('[id^="field-ohhalfday-closed-thursday-"][value="0"]');
var thursday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-thursday-"][value="1"]');
var thursday_lunch_closed = document.querySelector('[id^="field-ohlunch-thursday-"][value="1"]');
var thursday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-thursday-"][value="0"]');
var friday_open_allday = document.querySelector('[id^="field-ohhalfday-closed-friday-"][value="0"]');
var friday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-friday-"][value="1"]');
...
var sunday_open_halfday = document.querySelector('[id^="field-ohhalfday-closed-sunday-"][value="1"]');
var sunday_lunch_closed = document.querySelector('[id^="field-ohlunch-sunday-"][value="1"]');
var sunday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-sunday-"][value="0"]'); // openinghours_halfday_closed_general und openinghourslunchbreak_general auslesen

var oh_halfday_lunch = document.querySelector('[id^="field-ohhalfday-closed-general-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement; // openinghours_general und closinghours_general auslesen

var oh_general = document.querySelector('[id^="field-ohstart-general-"]').parentElement.parentElement.parentElement.parentElement; // lunchbreakstart_general und lunchbreakend_general auslesen

var oh_lunchtime = document.querySelector('[id^="field-ohlunch-start"]').parentElement.parentElement.parentElement.parentElement; // Werte auf 0 setzen, wenn ausgeblendet //
//General
...
var oh_lunchtime_monday = document.querySelector('[id^="field-ohlunch-start-monday-"]').parentElement.parentElement.parentElement.parentElement; //Dienstag

var oh_halfday_lunch_tuesday = document.querySelector('[id^="field-ohlunch-tuesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_tuesday = document.querySelector('[id^="field-ohstart-tuesday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_tuesday = document.querySelector('[id^="field-ohlunch-start-tuesday-"]').parentElement.parentElement.parentElement.parentElement; //Mittwoch

var oh_halfday_lunch_wednesday = document.querySelector('[id^="field-ohlunch-wednesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_wednesday = document.querySelector('[id^="field-ohstart-wednesday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_wednesday = document.querySelector('[id^="field-ohlunch-start-wednesday-"]').parentElement.parentElement.parentElement.parentElement; //Donnerstag

var oh_halfday_lunch_thursday = document.querySelector('[id^="field-ohlunch-thursday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_thursday = document.querySelector('[id^="field-ohstart-thursday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_thursday = document.querySelector('[id^="field-ohlunch-start-thursday-"]').parentElement.parentElement.parentElement.parentElement; //Freitag

var oh_halfday_lunch_friday = document.querySelector('[id^="field-ohlunch-friday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_friday = document.querySelector('[id^="field-ohstart-friday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_friday = document.querySelector('[id^="field-ohlunch-start-friday-"]').parentElement.parentElement.parentElement.parentElement; //Samstag

var oh_halfday_lunch_saturday = document.querySelector('[id^="field-ohlunch-saturday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_saturday = document.querySelector('[id^="field-ohstart-saturday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_saturday = document.querySelector('[id^="field-ohlunch-start-saturday-"]').parentElement.parentElement.parentElement.parentElement; //Sonntag

var oh_halfday_lunch_sunday = document.querySelector('[id^="field-ohlunch-sunday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
var oh_sunday = document.querySelector('[id^="field-ohstart-sunday-"]').parentElement.parentElement.parentElement.parentElement;
var oh_lunchtime_sunday = document.querySelector('[id^="field-ohlunch-start-sunday-"]').parentElement.parentElement.parentElement.parentElement; // EventListener WeekDays
...
sunday_lunch_notclosed.addEventListener("click", openinghours_halfday); // Hide all Days
...
function openinghours_repeat() {
  ...
  if (general_open_halfday.checked === true) {
    oh_lunchtime.style.display = "none";
    document.querySelector('[id^="field-ohlunch-general-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (monday_open_halfday.checked === true) {
    oh_lunchtime_monday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-monday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (tuesday_open_halfday.checked === true) {
    oh_lunchtime_tuesday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-tuesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (wednesday_open_halfday.checked === true) {
    oh_lunchtime_wednesday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-wednesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (thursday_open_halfday.checked === true) {
    oh_lunchtime_thursday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-thursday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (friday_open_halfday.checked === true) {
    oh_lunchtime_friday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-friday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (saturday_open_halfday.checked === true) {
    oh_lunchtime_saturday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-saturday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }

  if (sunday_open_halfday.checked === true) {
    oh_lunchtime_sunday.style.display = "none";
    document.querySelector('[id^="field-ohlunch-sunday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "none";
  }
...
function openinghours_halfday() {
  ...
  if (general_open_allday.checked === true && general_lunch_closed.checked === true) {
    oh_lunchtime.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-general-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (monday_open_allday.checked === true && monday_lunch_closed.checked === true) {
    oh_lunchtime_monday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-monday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (tuesday_open_allday.checked === true && tuesday_lunch_closed.checked === true) {
    oh_lunchtime_tuesday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-tuesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (wednesday_open_allday.checked === true && wednesday_lunch_closed.checked === true) {
    oh_lunchtime_wednesday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-wednesday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (thursday_open_allday.checked === true && thursday_lunch_closed.checked === true) {
    oh_lunchtime_thursday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-thursday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (friday_open_allday.checked === true && friday_lunch_closed.checked === true) {
    oh_lunchtime_friday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-friday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (saturday_open_allday.checked === true && saturday_lunch_closed.checked === true) {
    oh_lunchtime_saturday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-saturday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
  ...
  if (sunday_open_allday.checked === true && sunday_lunch_closed.checked === true) {
    oh_lunchtime_sunday.style.display = "flex";
    document.querySelector('[id^="field-ohlunch-sunday-"]').parentElement.parentElement.parentElement.parentElement.parentElement.style.display = "flex";
  }
