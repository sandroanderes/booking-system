...
var oh_repeat_none = document.querySelector('[id^="field-ohrepeat-"][value="0"]');
...
var sunday_lunch_notclosed = document.querySelector('[id^="field-ohlunch-sunday-"][value="0"]');
