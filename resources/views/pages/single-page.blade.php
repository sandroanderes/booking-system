                    ...
                    @if ($table->id)
                        <div class="col mb-4">
                            <div class="card border-success mb-3">
                                <a href="#" data-toggle="modal" data-target="#modal-{{ $table->gastrotable }}">
                                    <h5 class="card-header p-3 bg-transparent border-success text-center">
                                        <b>{{ $table->gastrotable }}er Tische</b>
                                    </h5>
                                </a>
                                <div class="card-body text-center">
                                    <p class="card-text mb-3">Zurzeit sind noch x von {{ $table->gastrotable_number }}
                                        {{ $table->gastrotable_number > 1 ? 'Tischen' : 'Tisch' }} verfügbar.
                                    </p>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#modal-{{ $table->gastrotable }}">
                                        Jetzt reservieren
                                    </button>
                                </div>
                            </div>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <output id="duration_output">{{($data->duration_min_h+$data->duration_max_h)/2}}</output> h
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Verfügbare Zeitfenster*</label>
